...
class CandidatsControllerTest < ActionController::TestCase
  ...
  test "should create candidat" do
    assert_difference('Candidat.count') do
      post :create, candidat: { name: @candidat.name, password: 'secret', password_confirmation: 'secret', string: @candidat.string }
    end
  ...
  test "should update candidat" do
    patch :update, id: @candidat, candidat: { name: @candidat.name, password: 'secret', password_confirmation: 'secret', string: @candidat.string }
    assert_redirected_to candidat_path(assigns(:candidat))
  end
